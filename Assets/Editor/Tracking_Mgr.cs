...
[System.Serializable]
public class Tracking_Mgr : EditorWindow
{
    ...
    [MenuItem("CSSALT/Tracking Preferences %P")]


    static void Init()
    {
        // Get existing open window or if none, make a new one:
        Tracking_Mgr window = (Tracking_Mgr)GetWindow(typeof(Tracking_Mgr));
        ReadPrefsFromScene();
        window.Show();
    }
    ...
    void OnGUI()
    {
        ...
        if (isBasicSceneSetUp)
        {
            ...
            /*
            newindexPlateStatus = EditorGUILayout.Toggle("Standard Index Plate", GameObject.Find("IndexPlate"));
            isIndexPlateActive = GameObject.Find("IndexPlate");
